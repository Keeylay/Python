...
class User():
    ...
    def validate_registeration(data):
        ...
        if len(data['first_name']) < 2 or len(data['first_name']) > 30:
            is_valid = False
            flash("First name should be between 2 and 30 characters.")

        if len(data['last_name']) < 2 or len(data['last_name']) > 30:
            is_valid = False
            flash("Last name should be between 2 and 30 characters.")
